...
class Articulo(models.Model):
	...
	portada = models.ImageField(upload_to='portadas', default='portada01.png', blank=True, null=True) #el otro tipo de dato es FileField para subir cualquier tipo de archivo
